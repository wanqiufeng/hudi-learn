...
public class CanalDataParserTest {
    ...
    public void buildJsonDataString() {
        ...
        List<String> strings = CanalDataProcessor.buildJsonDataString(testData, partitionKey);
        ...
        List<String> strings2 = CanalDataProcessor.buildJsonDataString(testData, partitionKey);
        ...
        List<String> strings1 = CanalDataProcessor.buildJsonDataString(maps, partitionKey);
